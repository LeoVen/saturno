...
| E05 | Requirements, Assignments & Validation | in-review | Weekly loads + teacher assignments configured; bad config warns | [epics/E05-requirements-assignments-validation.md](epics/E05-requirements-assignments-validation.md) |
